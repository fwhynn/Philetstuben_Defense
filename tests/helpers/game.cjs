...
function load({ headless = false, initialProfile = null, initialStorage = {}, rotateView = null, pickSlot = null, project = null, boardBox = null } = {}) {
  ...
  return { buildings: vm.runInNewContext("HexBuildings", context), data: vm.runInNewContext("HexData", context), waves: vm.runInNewContext("HexWaves", context), a: context.api, upgradeSelectedTower: context.upgradeSelectedTower, selectSlot: context.selectSlot, buyTower: context.buyTower, sellSelectedTower: context.sellSelectedTower, slotPositions: context.slotPositions, nextSourcePoints: context.nextSourcePoints, timers, elements, storage, documentListeners, globalListeners, document:context.document };
}
