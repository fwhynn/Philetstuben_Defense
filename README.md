...
Im aktuellen Repository ist kein `tag-webhook.php` vorhanden. Die frühere Anleitung zu automatischen Tag-Deployments ist daher keine gültige Anleitung für diesen Checkout. `serve.cjs` ist der lokale Entwicklungsserver; vorhandene externe Hosting-Konfigurationen wurden nicht überprüft.
